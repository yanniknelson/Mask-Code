...
void changeEyes (int Emote) {
  ...
  switch (Emote) {
      ...
      case 2:    // your hand is on the sensor
        drawEye(O_R_bmp, left_eye);
        drawEye(O_L_bmp, right_eye);
        Serial.println('O');
        break;
      ...
      case 17:
        ...
        break;
      case 18:
        drawEye(Big_Heart_bmp_left, left_eye);
        drawEye(Big_Heart_bmp_left, right_eye);
        break;
      case 19:
        drawEye(Small_Heart_bmp, left_eye);
        drawEye(Small_Heart_bmp, right_eye);
        break;
      case 20:
        for (int i=0; i <=3; i++){
          drawEye(Big_Heart_bmp_left, left_eye);
      ...
      case 21:
        for (int i=0; i <=8; i++){
          drawEye(Timer1_bmp, right_eye);
          drawEye(Timer1_bmp, left_eye);
          delay(200);
          drawEye(Timer2_bmp, right_eye);
          drawEye(Timer2_bmp, left_eye);
          delay(200);
          }
        Emote = random(0, 22);
        changeEyes(Emote);
...
void loop(void)
{
  ...
  if (((new_time - old_time) > time_match)&& onTimer) {
